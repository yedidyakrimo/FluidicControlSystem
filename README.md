...
* **Excel Export:** Export experimental data to well-formatted Excel files with templates.
...
* **Controller:** NI USB-6002 / MCusb-1408FS-Plus
...
* **`ni_daq/`** - NI USB-6002 and MCusb-1408FS-Plus DAQ control
...
* **`iv_program_tab.py`** - I-V program editor
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/yedidyakrimo/FluidicControlSystem.git
...
3. **Install hardware drivers (optional):**
   ...
   * MCC DAQ drivers for MCusb-1408FS-Plus
...
#### Write Program IV Tab
- Write custom I-V experiment programs
- Execute multi-step I-V measurements
...
- Level readings
- Valve states
- I-V measurements (when applicable)

The system also supports Excel export with customizable templates located in the `templete_exel/` directory.

### Documentation
Comprehensive documentation is available in the `docs/` directory:
- **Installation Guide:** `docs/INSTALLATION_GUIDE.md`
- **Code Documentation:** `docs/CODE_DOCUMENTATION.md`
- **Excel Export Guide:** `docs/EXCEL_EXPORT_DOCUMENTATION.md`
- **Main Tab Layout:** `docs/Main_Tab_Button_Layout_Documentation.md`
- **Keithley Documentation:** `docs/KEITHLEY_READ_COMMAND_DOCUMENTATION.md`
- **Pump Setup:** `docs/PUMP_SETUP.md`
- And more...
...
### Contact
For questions or support, please contact the research team at Bar-Ilan University.
